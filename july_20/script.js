...
function CorrectAnswer() {
  ...
  document.getElementById("img_here").src="https://raw.githubusercontent.com/cheesycat69/daily_dose/main/july_20/touch.jpeg";
  document.getElementById("video").src="https://www.youtube.com/embed/wybBLBXMdk4?autoplay=1";
  document.getElementById("video_container").style.display="block";
  document.getElementById("video_heading").innerHTML="<h1>Mariah Carey - Touch My Body</h1>";
}
