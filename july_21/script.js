...
function CorrectAnswer() {
  ...
  document.getElementById("img_here").src="https://raw.githubusercontent.com/cheesycat69/daily_dose/main/july_21/sorry.jpeg";
  document.getElementById("video").src="https://www.youtube.com/embed/BerNfXSuvJ0?autoplay=1";
  document.getElementById("video_container").style.display="block";
  document.getElementById("video_heading").innerHTML="<h1>Justin Bieber - Sorry</h1>";
}
