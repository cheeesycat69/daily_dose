...
function CorrectAnswer() {
  ...
  document.getElementById("img_here").src="https://raw.githubusercontent.com/cheesycat69/daily_dose/main/august_9/sorry.jpeg";
  document.getElementById("video").src="https://www.youtube.com/embed/26WBT1ZdLdc?autoplay=1";
  document.getElementById("video_container").style.display="block";
  document.getElementById("video_heading").innerHTML="<h1>Akon - Sorry</h1>";
}
