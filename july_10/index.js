window.onload = function() {
    ...
    function validate(e) {
        ...
        if(text.toLowerCase().trim() === "even if the sky is falling down") {
            runConfetti();
            ...
            document.getElementById("img_here").src="https://raw.githubusercontent.com/cheesycat69/daily_dose/main/july_10/down.jpeg";
            document.getElementById("video").src="https://www.youtube.com/embed/oUbpGmR1-QM?autoplay=1";
